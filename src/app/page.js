                ...
                <div className="container relative z-2">
                    <div className="grid grid-cols-1 text-center">
                        <div className="">
                            ...
                            <p className="text-slate-400 dark:text-white/60 text-lg max-w-xl mx-auto">An intelligent system that connects your CRM to accounting, automating invoice creation, validation, and finalization with AI-powered insights.</p>

                            <div className="mt-6">
                                <Link href="#features" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-amber-400 hover:bg-amber-500 border-amber-400 hover:border-amber-500 text-white rounded-md">Learn More</Link>

                                <p className="text-slate-400 dark:text-white/60 text-sm mt-3">Help us shape the future of automated invoicing</p>
                            </div>
                        </div>
                    </div>
                </div>
